...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (sidebarToggleBtn && sidebar) {
        // تنفيذ تبديل السايدبار عند النقر على الزر
        sidebarToggleBtn.addEventListener('click', function(e) {
            e.preventDefault();
            sidebar.classList.toggle('show');
            
            // إذا كانت الشاشة كبيرة، قم بتبديل حالة التوسيع للمحتوى أيضًا
        ...
        // التحقق من حالة السايدبار المحفوظة
    ...
    // تعديل السايدبار عند تغيير حجم النافذة
    window.addEventListener('resize', function() {
        if (window.innerWidth >= 992) {
            // للشاشات الكبيرة نحافظ على آخر حالة للسايدبار
            const savedSidebarState = localStorage.getItem('sidebarState');
            ...
            // للشاشات الصغيرة نغلق السايدبار افتراضيًا
            sidebar.classList.remove('show');
        }
    });
    
    // تنشيط التلميحات للأزرار
...
// تنعيم التمرير عند النقر على روابط السايدبار
document.addEventListener('DOMContentLoaded', function() {
    const sidebarLinks = document.querySelectorAll('.sidebar .nav-link');
    
    sidebarLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            // إغلاق السايدبار في الشاشات الصغيرة عند النقر على رابط
            if (window.innerWidth < 992) {
                const sidebar = document.querySelector('.sidebar');
                if (sidebar) {
                    sidebar.classList.remove('show');
